        ...
        <>
            ...
            <div>
                <Swiper
                    ...
                    modules={[Autoplay]}
                    className="mySwiper mb-5 pb-4"
                >
                    <SwiperSlide>
                        <img src={insta1} className="img-fluid" width={300} alt="" />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src={insta2} className="img-fluid" width={300} alt="" />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src={insta3} className="img-fluid" width={300} alt="" />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src={insta4} className="img-fluid" width={300} alt="" />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src={insta5} className="img-fluid" width={300} alt="" />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src={insta6} className="img-fluid" width={300} alt="" />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src={insta1} className="img-fluid" width={300} alt="" />
                    </SwiperSlide>
